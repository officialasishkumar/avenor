...
class ColorSchemeToggle(Component):
    """A ColorSchemeToggle component.
...
- w (string | number | dict; optional):
    ...
    responsive styles."""
    _children_props: typing.List[str] = ['lightIcon', 'darkIcon']
    _base_nodes = ['lightIcon', 'darkIcon', 'children']
    _namespace = 'dash_mantine_components'
    _type = 'ColorSchemeToggle'
    Gradient = TypedDict(
        "Gradient",
            {
            "from": str,
    ...
    def __init__(
        self,
        computedColorScheme: typing.Optional[Literal["dark", "light"]] = None,
        lightIcon: typing.Optional[ComponentType] = None,
        darkIcon: typing.Optional[ComponentType] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'aria-*', 'attributes', 'autoContrast', 'bd', 'bdrs', 'bg', 'bga', 'bgp', 'bgr', 'bgsz', 'bottom', 'c', 'className', 'classNames', 'color', 'computedColorScheme', 'darkHidden', 'darkIcon', 'data-*', 'disabled', 'display', 'ff', 'flex', 'fs', 'fw', 'fz', 'gradient', 'h', 'hiddenFrom', 'inset', 'left', 'lh', 'lightHidden', 'lightIcon', 'loading_state', 'lts', 'm', 'mah', 'maw', 'mb', 'me', 'mih', 'miw', 'ml', 'mod', 'mr', 'ms', 'mt', 'mx', 'my', 'opacity', 'p', 'pb', 'pe', 'pl', 'pos', 'pr', 'ps', 'pt', 'px', 'py', 'radius', 'right', 'size', 'style', 'styles', 'ta', 'tabIndex', 'td', 'top', 'tt', 'unstyled', 'variant', 'visibleFrom', 'w']
        ...
        super(ColorSchemeToggle, self).__init__(**args)

setattr(ColorSchemeToggle, "__init__", _explicitize_args(ColorSchemeToggle.__init__))
